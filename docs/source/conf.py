...
exclude_patterns = [
    # This file is included into the index.rst, and to suppress
    # warnings about duplicate labels, we have to exclude it
    # from the usual documentation processing.
    'pros-and-cons.rst',
    # Also, we don't want to generate docs from the static files:
    '_static/*'
]
...
latex_documents = [
  ('index', 'example.tex', u'Example CL Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'example', u'Example CL Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'example', u'Example CL Documentation',
   u'', 'example', 'Example of using Sphinx documentation system with Common Lisp.',
   'Miscellaneous'),
]
